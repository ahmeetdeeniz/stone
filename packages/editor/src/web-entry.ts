...
import type { Locale } from "@stone/i18n";
...
function initialize(markdownSource: string, readOnly: boolean, locale: Locale): void {
  view?.destroy();
    ...
    [
      ...
      EditorView.theme({
        ...
        ".stone-live-blockquote": {
          ...
          borderLeft: "3px solid color-mix(in srgb, var(--stone-accent) 45%, transparent)",
          paddingLeft: "14px",
        },
        ".stone-live-callout": {
          display: "block",
          borderLeft: "4px solid var(--stone-accent)",
          backgroundColor: "color-mix(in srgb, var(--stone-accent) 9%, var(--stone-surface))",
          borderRadius: "8px",
          padding: "10px 14px",
          margin: "8px 0",
        },
        ...
        ".stone-frontmatter-summary": {
          color: "color-mix(in srgb, var(--stone-text) 70%, transparent)",
          backgroundColor: "var(--stone-surface)",
          border: "1px solid color-mix(in srgb, var(--stone-accent) 22%, transparent)",
          borderRadius: "8px",
          padding: "8px 12px",
          margin: "4px 0 12px",
          fontSize: "0.84em",
...
window.addEventListener("message", (event) => {
  ...
  if (value.type === "initialize") {
    ...
    initialize(
      ...
      value.payload.readOnly ?? false,
      value.payload.locale ?? "en",
    );
